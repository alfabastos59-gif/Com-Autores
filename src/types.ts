...
export type AdminSection = 'dashboard' | 'emprestimos' | 'livros' | 'alunos' | 'sugestoes' | 'usuarios_adm' | 'auditoria' | 'relatorios' | 'backup' | 'configuracoes' | 'carteirinhas' | 'autores';
...
export interface AuthorItem {
  ...
  quoteSource: string;
  referenceUrl?: string;
  additionalQuotes?: { text: string; source?: string }[];
  active?: boolean;
  createdAt?: string;
}
